...
.login-form input[type="submit"] {
    width: 102%; /* Full width for the submit button */
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="register-link">
            <p>Don't have an account? <a href="add-user">Register here</a></p>
        </div>
    ...
    <script>
        function toggleSidebar() {
            ...
            if (sideNav.classList.contains('open')) {
                ...
                mainContent.style.marginLeft = '200px'; // Set margin when sidebar is open
            }
        }
    </script>
</body>
